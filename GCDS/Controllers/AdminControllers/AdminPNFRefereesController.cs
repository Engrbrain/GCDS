...
{
    public class AdminPNFRefereesController : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: AdminPNFReferees
        ...
        // GET: AdminPNFReferees/Details/5
        ...
        // POST: AdminPNFReferees/Delete/5
